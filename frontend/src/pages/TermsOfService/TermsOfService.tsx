        ...
        <div className="mx-auto max-w-3xl space-y-8 rounded-3xl border bg-white p-8 shadow-sm md:p-12">
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            <section>
              ...
              <p>
                By accessing or using PDF QR Generator, you agree to be bound by these Terms of Service. 
            ...
            <section>
              ...
              <p>
                PDF QR Generator is a tool that allows users to authenticate with their Google account, upload PDF documents to their personal Google Drive, 
            ...
            <section>
              ...
              <p>
                In no event shall PDF QR Generator or its creators be liable for any indirect, incidental, special, consequential or punitive damages, 
